...
get_and_format_plate_df_from_manifest <- function(manifest_df, plateID, columns_for_scoring, cols_to_categorize, imbalance_fixer, 
  ...
  # Categorize columns as specified by list of vectors in columns_for_scoring
  # # cols_to_categorize is list of character vectors with structure (col_name,num_cats,na_replacement,categorized_col_name)
  plate_df_aux <- categorize_cols(plate_df_aux, columns_for_scoring)
